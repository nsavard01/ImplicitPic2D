module mod_ZebraSolver
    ...
    type :: ZebraSolver
        ...
        real(real64), allocatable :: sourceTerm(:,:), solution(:,:), residual(:,:), horzCoeffs(:,:), vertCoeffs(:,:), centerCoeffs(:,:) !, rowBoundCoeffs(:,:,:), colBoundCoeffs(:,:, :) ! lower, then upper diagonals
    ...
    interface ZebraSolver
        module procedure :: GSSolver_constructor
    end interface ZebraSolver

contains

    type(ZebraSolver) function GSSolver_constructor(omega, evenGridBool) result(self)
        ...
        self%iterNumber = 0
        self%Residual = 0
        self%evenGridBool = evenGridBool
    ...
    subroutine constructPoissonOrthogonal(self, N_x, N_y, diffX, diffY, NESW_wallBoundaries, boundaryConditions)
        ...
        real(real64), intent(in) :: diffX(:), diffY(:)

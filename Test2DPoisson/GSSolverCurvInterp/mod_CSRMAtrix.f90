        ...
        do j = 1, N_y
            do i = 1, N_x
                ...
                if (boundaryConditions(k) == 0) then
                    ...
                    C_N = 0.5d0 * (delX_E + delX_W) / (delY_N) ! N
                    C_E = 0.5d0 * (delY_N + delY_S) / (delX_E) ! E
                    C_S = 0.5d0 * (delX_E + delX_W) / (delY_S) ! S
                    C_W = 0.5d0 * (delY_N + delY_S) / (delX_W) ! W
                    ...
                    case(2)
                        ...
                        if (j == 1) then
                            ...
                            if (i /= 1 .and. i /= N_x) then 
                                ...
                                ! lower left corner
                                delX_E = diffX(i)
                                C_E = 2.0d0 * delY_N / (delX_E) ! E
                                C_N = 2.0d0 * delX_E * C_N
                                C_O = -(C_N + C_E) ! O
                                ! Origin
                                matValIdx = matValIdx + 1
                                columnIndex(matValIdx) = k
                                ...
                                ! lower right corner
                                delX_W = diffX(i-1)
                                C_W = 2.0d0 * delY_N / (delX_W) ! W
                                C_N = 2.0d0 * delX_W * C_N
                                C_O = -(C_N + C_W) ! O
                                ! West
                                matValIdx = matValIdx + 1
                                columnIndex(matValIdx) = k-1

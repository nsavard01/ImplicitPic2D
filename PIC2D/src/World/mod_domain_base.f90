module mod_domain_base
    ...
    type :: domain_base
        ...
        integer(int32) :: N_x, N_y, N_x_cells, N_y_cells, NESW_wall_boundaries(4) ! amount of nodes in x and y direction
    contains
...
contains
    type(domain_base) function constructor(N_x, N_y, NESW_wall_boundaries, length_x, length_y) result(self)
        ! Construct domain object, initialize grid, dx_dl, and nodeVol.
        integer(int32), intent(in) :: N_x, N_y, NESW_wall_boundaries(4)
